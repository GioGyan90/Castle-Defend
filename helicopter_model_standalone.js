(function (root) {
    function createHelicopterModel(THREERef) {
        const THREE = THREERef || root.THREE;
        if (!THREE) {
            throw new Error('THREE is required before creating the helicopter model.');
        }
    ...
    root.createHelicopterModel = createHelicopterModel;

    if (typeof module !== 'undefined' && module.exports) {
        module.exports = createHelicopterModel;
    }
